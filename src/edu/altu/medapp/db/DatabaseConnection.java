...
public class DatabaseConnection implements IDatabase {
    ...
    private static final String USER = "postgres.hcqvlvovnysjnftiodnl";
    ...
    private static String loadPassword() {
        ...
        try (FileInputStream input = new FileInputStream("config.properties")) {
            ...
            if (password == null || password.isBlank()) {
                throw new RuntimeException("Database password is not set in config.properties");
            }
            return password;
        } catch (IOException e) {
            throw new RuntimeException("Cannot load password from config.properties", e);
        }
    }
